  ...
  <script>
		function start(){
			...
			if(value=="1"){
				...
				document.getElementById("depart").setAttribute("href","depart.php?condition=1");
			}
...
<nav>
    <ul class="flex-nav">
        <li><a href="javascript:void(0);" id="arrival"> |  入境航班即時資訊   |</a></li>
        <li id="l" style="color:black;"><a href="depart.php" id="depart">   |出境航班即時資訊   |</a></li>
        <li><a href="line chart.php" id="line chart">  | 2019年出入境統計   |</a></li>
        <li><a href="final2(1).php" id="final21">   |2019年每月人數報表  | </a></li>
		<li><a href="list.html" id="list">   |回首頁  | </a></li>
    </ul>
</nav>
<img src="2.png" style="display:none" id="2">
...
var defaults = {
    margin: {top: 40, right: 0, bottom: 0, left: 0},//orange
    rootname: "TOP",
    format: ",d",
    title: "",
    width: 960*1.1,
...
function main(o, data) {
  ...
  if (data instanceof Array) {
    root = { EstimatedArrivalTime: rname, values: data };
  } else {
    root = data;
  }
  ...
  function display(d) {
    ...
    children.append("rect")
      ...
      .append("title")
        .text(function(d) { 
			if(d.ArrivalRemark=="已到ARRIVED")
			return "已到達_實際到達時間："+d.ActualArrivalTime
			if(d.ArrivalRemark=="準時ON TIME")
			return "尚未到達_預計到達時間："+d.EstimatedArrivalTime
			if(d.ArrivalRemark=="取消CANCELLED") return "班機取消"
		});
...
if (window.location.hash === "") {
    d3.json("https://ptx.transportdata.tw/MOTC/v2/Air/FIDS/Airport/Arrival/TPE?$format=JSON", function(err, res) {
        if (!err) {
            console.log(res);
            var data = d3.nest()
				.key(function(d) { return d.FlightDate; })
				.key(function(d) { return d.AirlineID; })
				.key(function(d) { return d.DepartureAirportID; })
				.key(function(d) { return d.FlightNumber; })
				.entries(res);
            main({title: "入境航班即時資訊"}, {EstimatedArrivalTime: "桃園中正機場->日期->航空公司->出發地->班機編號&到達狀態", values: data});
        }
    });
}
